...
class Embeddings_output(nn.Module):
    def __init__(self):
        ...
        self.de_block_1 = SpatialBlock(dim, 8, 1, False)
        self.de_block_2 = ChanBlock(dim, 1, False)
        self.de_block_3 = SpatialBlock(dim, 8, 1, False)
        self.de_block_4 = ChanBlock(dim, 1, False)
        self.de_block_5 = SpatialBlock(dim, 8, 1, False)
        self.de_block_6 = ChanBlock(dim, 1, False)
...
class SpatialBlock(nn.Module):
    def __init__(self, dim, win_size, ffn_expansion_factor, bias):
...
class Freqformer(nn.Module):
    def __init__(self):
        ...
        dim = 320
        #dim = 320
        self.Trans_block_1 = SpatialBlock(dim, 8, 1, False)
        self.Trans_block_2 = ChanBlock(dim, 1, False)
        self.Trans_block_3 = SpatialBlock(dim, 8, 1, False)
        self.Trans_block_4 = ChanBlock(dim, 1, False)
        self.Trans_block_5 = SpatialBlock(dim, 8, 1, False)
        self.Trans_block_6 = ChanBlock(dim, 1, False)
        self.Trans_block_7 = SpatialBlock(dim, 8, 1, False)
        self.Trans_block_8 = ChanBlock(dim, 1, False)
        self.Trans_block_9 = SpatialBlock(dim, 8, 1, False)
        self.Trans_block_10 = ChanBlock(dim, 1, False)
        self.Trans_block_11 = SpatialBlock(dim, 8, 1, False)
        self.Trans_block_12 = ChanBlock(dim, 1, False)
