...
model = NADeblurM().cuda()#.to(dtype=torch.float16)
out = model(inp)
print(out.shape)
...
with torch.cuda.device(0):
  ...
  print('{:<30}  {:<8}'.format('Computational complexity: ', macs))  # 110.99 GMac
