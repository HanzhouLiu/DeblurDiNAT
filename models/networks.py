...
def get_generator(model_config):
    ...
    elif generator_name == 'NADeblurM':
        model_g = NADeblurM.NADeblurM()
    elif generator_name == 'FFTformer':
        model_g = FFTformer.FFTformer()
    elif generator_name == 'MIMONet':
        model_g = MIMONet.MIMONet()
    elif generator_name == 'MPRNet':
        model_g = MPRNet.MPRNet()
    elif generator_name == 'Uformer':
        model_g = Uformer.Uformer()
    elif generator_name == 'Restormer':
        model_g = Restormer.Restormer()
    else:
