...
from models import Stripformer, FSformer, FSformer_v0, FSformer_v1, FSformer_B, FSformer_B1, FSformer_B2, FSformer_V2, FSformer_V3, FSformer_V4, FSformer_V5, FSformer_V6
...
def get_generator(model_config):
    ...
    if generator_name == 'Stripformer':
        ...
        model_g = FSformer_V5.FSformer_V6()
    else:
