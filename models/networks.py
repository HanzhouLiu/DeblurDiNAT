...
from models import Stripformer, FSformer, FSformer_v0, FSformer_v1, FSformer_B, FSformer_B1, FSformer_B2, FSformer_V2, FSformer_V3, FSformer_V4, FSformer_V5, FSformer_V6, FSformer_V7, FSformer_V8, Freqformer, Freqformer_V0, Freqformer_V1, Freqformer_V2, Freqformer_V3, Baseline, Freqformer_V4, SpikeDeblur, FSformer_V9
...
def get_generator(model_config):
    ...
    elif generator_name == 'FSformer_V9':
        model_g = FSformer_V9.FSformer_V9()
