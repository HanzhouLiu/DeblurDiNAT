...
class Embeddings_output(nn.Module):
    def __init__(self):
        ...
        self.de_block_2 = HiBlock(dim, head_num, 2, 1, False)
        self.de_block_3 = LoBlock(dim, head_num, 2, 1, False)
        self.de_block_4 = HiBlock(dim, head_num, 2, 1, False)
        self.de_block_5 = LoBlock(dim, head_num, 2, 1, False)
        self.de_block_6 = HiBlock(dim, head_num, 2, 1, False)
...
class FSformer_B2(nn.Module):
    def __init__(self):
        super(FSformer_B2, self).__init__()
        ...
        self.Trans_block_2 = HiBlock(dim, head_num, 2, 1, False)
        self.Trans_block_3 = LoBlock(dim, head_num, 2, 1, False)
        self.Trans_block_4 = HiBlock(dim, head_num, 2, 1, False)
        self.Trans_block_5 = LoBlock(dim, head_num, 2, 1, False)
        self.Trans_block_6 = HiBlock(dim, head_num, 2, 1, False)
        self.Trans_block_7 = LoBlock(dim, head_num, 2, 1, False)
        self.Trans_block_8 = HiBlock(dim, head_num, 2, 1, False)
        self.Trans_block_9 = LoBlock(dim, head_num, 2, 1, False)
        self.Trans_block_10 = HiBlock(dim, head_num, 2, 1, False)
        self.Trans_block_11 = LoBlock(dim, head_num, 2, 1, False)
        self.Trans_block_12 = HiBlock(dim, head_num, 2, 1, False)
...
model = FSformer_B().cuda().to(dtype=torch.float16)
out = model(inp)
print(out.shape)
