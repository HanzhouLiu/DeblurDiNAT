...
parser.add_argument('--job_name', default='spikedeblur',
...
class Trainer:
    ...
    def train(self):
        ...
        if os.path.exists(os.path.join(model_dir, 'last_FSformer_pretrained.pth')):
            print('load_pretrained')
            training_state = (torch.load(os.path.join(model_dir, 'last_FSformer_pretrained.pth')))
...
if __name__ == '__main__':
    with open(os.path.join('config/', args.job_name, 'config_pretrained.yaml'), 'r') as f:
